...
@Named
@SessionScoped
public class PhoneTypeConverter01 implements Converter, Serializable {
	
	@EJB
	private UserService userService;
	
	private static final Logger LOGGER = Logger.getLogger(PhoneTypeConverter01.class.getName());
